  ...
  return (
    <div className='bg-[#fcf8ed]'>
      <div className="pt-16 pb-8 text-2xl text-[#453327] text-center lg:px-60 md:px-36 sm:px-20 px-10">
        <h2
          className={`text-5xl font-bold mb-10 ${isVisible ? 'motion-safe:animate-fadeInUp' : ''}`}
          style={{ fontFamily: 'FontType1' }}
          ref={elementRef}
        >
          ABOUT US
        </h2>
