  ...
  return (
    <footer className="bg-[#fcf8ed] text-brown-700 py-8 px-6 text-sm text-[#876055]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-around items-center space-y-6 md:space-y-0 md:space-x-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-start space-y-6 md:space-y-0 md:space-x-8">
          <div className="flex flex-col">
            <ul className="flex flex-wrap space-x-4 md:space-x-0 md:flex-col md:space-y-1">
          ...
          <div className="flex flex-col">
            ...
            <ul className="flex flex-col space-y-1">
              ...
              <li className='flex space-x-2 items-start'>
                ...
                <a href="mailto:maaticeramics@gmail.com" className="hover:underline mt-1 h-4">maaticeramics@gmail.com</a>
              </li>
              <li className='flex space-x-2 items-start'>
                <img src={India} alt="india" className='mt-1 h-4'/>
                <a href="#" className="hover:underline">Call Us +91 8853782375</a>
              </li>
            </ul>
          </div>
        </div>
